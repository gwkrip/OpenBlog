...
function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <button type="submit" disabled={loading} className="btn-primary w-full gap-2.5 py-3">
        {loading ? (
...
// ── Page — Suspense wraps the form (required for useSearchParams) ──
  ...
  return (
    <div className="min-h-screen bg-[var(--paper-warm)] flex items-center justify-center p-4 relative">
      ...
      <div className="w-full max-w-sm relative animate-scale-in">
        <div className="mb-6">
          <Link href="/" className="inline-flex items-center gap-2 text-sm text-ink-subtle hover:text-accent transition-colors">
        ...
        <div className="card bg-white p-8">
          {/* Suspense required — useSearchParams needs it for static rendering */}
          <Suspense fallback={
